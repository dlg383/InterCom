...
parser.add_argument("-l", "--listening_port", type=int, default=9320, help="My listening port")
...
parser.add_argument("-p", "--destination_port", type=int, default=2000, help="Destination (interlocutor's listing-) port")
