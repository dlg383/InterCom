...
#parser.add_argument("-l", "--listening_port", type=int, default=11367, help="My listening port")
#parser.add_argument("-a", "--destination_address", type=int_or_str, default="79.144.202.239", help="Destination (interlocutor's listening) address")
#parser.add_argument("-p", "--destination_port", type=int, default=54320, help="Destination (interlocutor's listing-) port")
